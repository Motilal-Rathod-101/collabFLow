...
// interface Props {
//   openDialog: () => void; // passed from Dashboard
// }
...
//         <h2 className="text-md text-zinc-800">Project Overview</h2>
//         <Link
//           to="/projects"
...
//             <div className="w-16 h-16 mx-auto mb-4 bg-zinc-200 rounded-full flex items-center justify-center">
//               <FolderOpen size={32} />
//             </div>
...
//                     <span className="text-zinc-600">{project.progress || 0}%</span>
//                   </div>
